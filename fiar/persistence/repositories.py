...
class FriendshipRepository:
    ...
    def add_friendship(self, user: User, friend: User):
        self.db.session.add(Friendship(user.id, friend.id))
        self.db.session.add(Friendship(friend.id, user.id))
        self.db.session.commit()

    def add_request(self, from_user: User, to_user: User):
        self.db.session.add(FriendshipRequest(from_user.id, to_user.id))
        self.db.session.commit()
